...
public class Main
{
    ...
    public static void main( String args[] )
    {
        ...
        String ip1 = "https://192.168.0.100";
        String ip2 = "https://192.168.0.101";
        String ip3 = "https://192.168.0.104";
        ...
        RunnableDemo R2 = new RunnableDemo( "deleteUser", ip1 );
        R2.start();

        RunnableDemo R411 = new RunnableDemo( "delenv", ip1 );
        R411.start();

        RunnableDemo R211 = new RunnableDemo( "deleteUser", ip1 );
        R211.start();
